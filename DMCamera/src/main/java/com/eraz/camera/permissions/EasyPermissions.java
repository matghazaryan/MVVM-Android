...
public class EasyPermissions {
     ...
     * @param perms   one ore more permissions, such as {@code android.Manifest.permission.CAMERA_PHOTO}.
    ...
    public static void requestPermissions(final Object object, String rationale,
                                          final int requestCode, final boolean isShowDialog, final String... perms) {
        requestPermissions(object, rationale,
                android.R.string.ok,
                android.R.string.cancel,
                requestCode, isShowDialog, perms);
    }
    ...
    public static void requestPermissions(final Object object, String rationale,
        ...
        if (isShowDialog && shouldShowRationale) {
